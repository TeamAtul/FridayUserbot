...
from fridaybot.plugins.sql_helper.locks_sql import get_locks
from fridaybot.plugins.sql_helper.locks_sql import is_locked
from fridaybot.plugins.sql_helper.locks_sql import update_lock
