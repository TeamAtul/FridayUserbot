...
from fridaybot.plugins.sql_helper.mute_sql import is_muted
from fridaybot.plugins.sql_helper.mute_sql import mute
from fridaybot.plugins.sql_helper.mute_sql import unmute
