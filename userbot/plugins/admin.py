...
CHAT_PP_ERROR = ("`Picin yenilənməsi ilə bağlı bəzi problemlər,`"
...
async def ban(bon):
    ...
    try:
        ...
        await bon.edit(
            "`Mesaj üçün hüququm yoxdur! Ancaq yenə də qadağan edildi!`")
        return
...
async def nothanos(unbon):
    ...
    try:
        ...
        await unbon.edit(
            "```Uğurla qadağan olunmayıb. Başqa bir şans vermək.```")
