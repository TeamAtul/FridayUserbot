...
from fridayfridayfridayuserbot import OPEN_WEATHER_MAP_APPID as OWM_API
from fridayfridayfridayuserbot.events import errors_handler, register
...
async def set_default_city(city):
    """ For .ctime command, change the default fridayfridayfridayuserbot country for date and time commands. """
