    ...
    try:
        await borg(
            functions.account.UpdateProfileRequest(  # pylint:disable=E0602
                ...
                last_name=last_name))
        await event.edit("Uğurla ad dəyişdirildi")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))
...
async def _(event):
    ...
    await event.edit("Profil şəkli yüklənir...")
    ...
    try:
        ...
        if photo:
            await event.edit("Bir neçə dəqiqə gözləyin ...")
            ...
            try:
                ...
                await event.edit("Mənim profil şəklim uğurla dəyişdirildi")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
