...
Mövcud Kodlar:
.tts LanguageCode bir mesaja cavab olaraq göstərin.
.tts LangaugeCode | söz"""
import asyncio
import os
import subprocess
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Invalid Syntax. Modul Dayandı.")
        return
    text = text.strip()
    lan = lan.strip()
    ...
    try:
        ...
        os.remove(required_file_name)
        await event.edit("Proses {} ({}) {} saniyədə hazır oldu!".format(text[0:97], lan, ms))
